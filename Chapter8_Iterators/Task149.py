...
'''This class is iterable and is also its own iterator. Split it into 2 classes:

CombinationsIterator, which is not iterable but has a __next__ method

Combinations, which has no __next__ function and for which the iterator is the CombinationsIterator class

When defining classes, remove unused methods, attributes and variables from them'''

...
'''
To organize promotions for baked goods, define a class that inherits from both Cake and Promo
Define the class PromoCake that inherits from both Cake and Promo
In the __init__ method, accept the arguments cake and promo and then call __init__ from the parent classes
Create a promo_cake object from the PromoCake class
Call the show_info method for this object. Try to guess the result before running it
Display the full_name property for this object
Display the "Method Resolution Order" for the PromoCake class
'''
